...
const GamePage = () => {
  ...
  const bgImage =
      "https://www.intigent.ca/wp-content/uploads/2024/03/career-development.jpeg";
  ...
  useEffect(() => {
    ...
    timersRef.current.push(darkenTimer, errorTimer);
  ...
  const handleRecoveryStart = () => {
    setScene("glitch");
    const t = setTimeout(() => setScene("terminal"), 800);
        ...
        {scene === "error" && (
            <div className="modal-overlay">
              <div className="error-box">
                ...
                <p>
                  서버 내부 장애로 인해{" "}
                  <strong>지원서 패킷 전송이 중단되었습니다.</strong>
                  <br />
                  귀하의 지원 이력은{" "}
                ...
                <button className="start-btn" onClick={handleRecoveryStart}>
                  서버 긴급 복구
                </button>
              </div>
            </div>
        ...
        {scene === "terminal" && (
            <div className="terminal-container">
              <div className="terminal-body">
                <p className="warning">
                  🚨 지원서 제출 서버가 응답하지 않습니다. 마지막 수정 기록에서 문제가
                  감지되었습니다.
                </p>
                <p className="highlight">
                  🛠 임시 복구 권한이 부여되었습니다. 서버를 직접 점검하고
                  복구하세요..
                </p>
                ...
                {loading && (
                    <div className="termLoading">
                      <div className="termSpinner" />
                      <span>복구 모드 진입 중…</span>
                    </div>
                )}
              </div>
            </div>
